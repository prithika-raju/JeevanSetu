  ...
  {/* add more later */}
                ...
                {selectedRole === "patient" && (
                  <div className="space-y-5 pt-6 border-t-2">
                    ...
                    <div>
                      <Label htmlFor="lastTransfusionDate" className="text-base font-medium text-foreground">
                        Last Transfusion Date
                      </Label>
                      <Input
  id="lastTransfusionDate"
  type="date"
  value={formData.lastTransfusionDate}
  onChange={(e) => handleInputChange("lastTransfusionDate", e.target.value)}
